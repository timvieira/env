...
function cython-clean {
    find . -name '*.cpp' -print0 |xargs -0 ack --print0 --files-with-matches '/\* Generated by Cython' | xargs -0 rm
    find . -name '*.c' -print0 |xargs -0 ack --print0 --files-with-matches '/\* Generated by Cython' | xargs -0 rm
}
