...
COMPILE_COMMAND = "mxmlc +configname=flex -compiler.warn-no-type-decl=false -compiler.source-path flare/flare.demos/src/ -file-specs=flare/flare.demos/src/tutorial.as"


SWF_TO_RUN = "flare/flare.demos/src/tutorial.swf" 
PORT = 2001
HOST = "localhost"
...
s.mount_proc("/compile_and_show"){|req, res|
  ...
  if output =~ /#{SWF_TO_RUN} \([0-9]/
      system "flashplayer10 #{SWF_TO_RUN}"
  end
}
